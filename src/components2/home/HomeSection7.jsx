...
const HomeSection7 = () => {
  ...
  return (
    <>
      ...
      >
        <div class="container px-0 ps-lg-0 mt-5">
          <div className="row m-0 mt-5 justify-content-center ">
            ...
            <div
              ref={scrollerRef}
              className="col-10 barshop overflow-x-scroll d-flex text-center justify-content-center   pt-5 fw-bolder"
            >
              {portfoliodata.map((i) => {
                return (
                  <div
                    className="fs-4   text- px-lg-4 px-2 pointer"
                    style={{
                      whiteSpace: "nowrap",
                      width: "max-content",
                    }}
            ...
            <div className="col-12 mt-5">
              <div className="row m-0 mt-5">
                {portfoliodata
                  ...
                  .videos.map((i) => {
                    return (
                      <div className="col-6 px-3 py-3 s">
