      ...
      >
        <div class="container px-0 ps-lg-0 ps-2">
          <div className="row m-0 justify-content-between">
            <div className="col-lg-6 col-12  mt-md-0  text-start d-md-block align-self-center">
              ...
              <p className="fs-5">
                ...
                video. Imagine transforming your brand with engaging video
                content that captivates your audience and boosts your online
                presence. Our team of experts can help you create videos that
                will boost your sales, or improve your brand awareness. Don't
                let this opportunity slip away - unlock your potential through
                video magic. Claim your consultation now!
              </p>
        ...
        <div
          className="behind position-absolute  end-0 z-0 pointerer"
        >
          <img
