    ...
    <>
      <div
        className={`col-12 position-fixed navbarer z-3 anton ${
          scrolled ? "bg-primarys py-3" : "py-4"
        }`}
      >
        <div className="container px-0 ps-lg-0 ps-2">
          <div className="row m-0">
            <div className="col-md-6 col-12">
              <div className="fs-1 text-light position-relative z-3">
                ROSHAN STUDIO
              </div>
            </div>
            <div
              className="d-flex justify-content-end position-fixed overflow-hidden  rounded-1 shadow p-1 end-0 z-3 me-lg-5 me-3  align-items-center"
              style={{ top: "1.3vh", width: "max-content" }}
            >
        ...
        <motion.div
          ...
          className="fixednavbar bg-primarys border-0 shadow-lg position-fixed z-0 w-25 top-0 h-100 end-0 p-5 d-lg-flex d-none justify-content-start align-items-center"
        >
          <div className="d-block text-start text-uppercase text-light  anton">
          ...
          <div className="d-block position-absolute text-start items bottom-0 pb-3 ">
            <div className="fs-1 text-light text-uppercase">Socials</div>
        ...
        <motion.div
          ...
          variants={variants}
          transition={{ duration: 0.3, delay: 0 }}
          className="fixednavbar bg-primarys border-0 shadow position-fixed z-0 w-100 top-0 h-100 end-0 p-5 d-lg-none d-flex justify-content-center align-items-center"
        >
          <div className="d-block text-center text-uppercase text-light anton">
            <div className="fs-1 py-3 items">Home</div>
            <div className="fs-1 py-3 items">Our Work</div>
            <div className="fs-1 py-3 items">Services</div>
            <div className="fs-1 py-3 items">About Us</div>
          ...
          <div className="d-block position-absolute text-center items  bottom-0  ">
            <div className="fs-1 text-light text-uppercase pb-2">Socials</div>
